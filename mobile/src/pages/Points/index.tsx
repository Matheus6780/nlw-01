...
const Points = () => {
  ...
  useEffect(() => {
    /**
     * Verifique de onde vem route.params pois em Home/index.tsx
     * você escolhe o estado e a cidade
     */
      ...
      { initialPosition[0] !== 0 && (
        ...
        initialRegion={{latitude: initialPosition[0], longitude: initialPosition[1], latitudeDelta: 0.014, longitudeDelta: 0.014}}>
          {points.map(point => (
            ...
            coordinate={{ latitude: point.latitude, longitude: point.longitude }} onPress={() =>handleNavigateToDetail(point.id)}>
    ...
    <View style={styles.itemsContainer}>
      ...
      {items.map(item => {
        return(
          ...
          activeOpacity={0.6} onPress={() => handleSelectedItem(item.id)}>
